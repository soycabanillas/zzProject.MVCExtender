...
namespace zzProject.MVCExtender.Metadata.Provider
{
    public class FluentMetadataProvider : DataAnnotationsModelMetadataProvider
    {
        ...
        public void Add(Type type, string propertyName, Action<ModelMetadata> modifier)
        {
            modifiers.GetOrAdd(
        ...
        public class MetadataRegistrar<TModel>
        {
            ...
            public MetadataRegistrar<TModel> ModelMetadata(Action<ModelMetadata> delegateModelMetadata)
            {
